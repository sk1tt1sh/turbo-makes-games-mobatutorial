...
public class GameOverUIController : MonoBehaviour {
  ...
  private void ReturnToMain() {
    if(_networkConnectionQuery.TryGetSingletonEntity<NetworkStreamConnection>(out var netConEntity)) {
      World.DefaultGameObjectInjectionWorld.EntityManager.AddComponent<NetworkStreamRequestDisconnect>(netConEntity);
    }
  ...
  private void ShowGameOverUI(TeamType team) {
    _gameOverPanel.SetActive(true);
    _gameOverText.text = $"{team.ToString()} team has won!";
  }
}